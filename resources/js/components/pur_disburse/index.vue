<script setup>
	...
	const getallRFD = async () => {
		let response = await axios.get("/api/get_allrfd");
                ...
                <div class="card">
                    <div class="card-body">
                        <div class="flex justify-between  mt-2 mb-0 absolute z-50 ">
                            <a href="/pur_disburse/new/0" class="btn btn-primary mt-2 mt-xl-0 text-white">
                            ...
                            <DataTable :data="get_allrfd" :options="options" class="display table table-bordered table-hover !border nowrap">
                                <thead>
                                    <tr>
                                        ...
                                        <th class="!text-xs bg-gray-100 uppercase" width="15%"> Status</th>
                                ...
                                <template #column-6="props">
                                    <div class="flex justify-center">
                                        <span class="badge bg-green-500 text-white !rounded-xl px-2 p-1" v-if="props.rowData.status=='Saved'">Saved</span>
                                ...
                                <template #column-7="props">
                                    <a :href="'/pur_disburse/view/'+props.rowData.id" class="btn btn-xs btn-warning text-white p-1" v-if="props.rowData.status=='Saved'|| props.rowData.status=='Cancelled'">
                                        <EyeIcon fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="menu-icon w-3 h-3 "></EyeIcon>
                                    </a>
                                    <a :href="'/pur_disburse/new/'+props.rowData.po_head_id" class="btn btn-xs btn-warning text-white text-white p-1" v-else>
                                        <EyeIcon fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="menu-icon w-3 h-3 "></EyeIcon>
                                    </a>
                                </template>
                            </DataTable>
