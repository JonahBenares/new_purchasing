        ...
        <div class="row">
            <div class="col-lg-12">
                <div class="flex justify-between mb-3 px-2">
                    <span class="">
                        <h3 class="card-title !text-lg m-0 uppercase font-bold text-gray-600">Purchase Order <small>Cancelled List</small></h3>
                    </span>
                    ...
                    <div class="card-body">
                        <div class="flex justify-between space-x-2 mt-3 mb-0 absolute z-50 ">
                            ...
                            <div class="space-x-1 pt-1 mt-1">
                                ...
                                <div class="relative group inline-block">
                                    <a href="/pur_po" class="w-20 !text-gray-400 !no-underline rounded-xl text-sm py-1 px-3 border ">
                                        Main List
                                    </a>
                                    <a href="/pur_po" class="absolute !no-underline rounded-xl text-sm py-1 px-3 -top-1 left-1/2 transform -translate-x-1/2 w-[93px] text-center scale-0 transition-all duration-150 bg-blue-500 text-white group-hover:scale-100 ">Show List</a>
                                </div>
                            </div>
                        </div>
                        <div class="pt-3">
