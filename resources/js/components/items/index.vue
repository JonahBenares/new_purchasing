        ...
        <div class="row">
            <div class="col-lg-12">
                <div class="flex justify-between mb-3 px-2">
                    <span class="">
                        <h3 class="card-title !text-lg m-0 uppercase font-bold text-gray-600">Items <small>List</small></h3>
                    </span>
                    ...
                    <div class="card-body">
                        <div class="flex justify-between">
                            ...
                            <span>
                                <div class="d-flex justify-content-between align-items-end flex-wrap space-x-2">
                                    ...
                                    <a  href="/items/new" class="btn btn-primary mt-2 mt-xl-0 text-white">
                        ...
                        <div class="table-responsive pt-3">
                            <table class="table table-bordered table-hover !border ">
                                <thead>
                                    <tr>
                                        <th class="!text-xs bg-gray-100 uppercase" width="30%"> Item Name</th>
                                        <th class="!text-xs bg-gray-100 uppercase" width="30%"> Specification </th>
                                        <th class="!text-xs bg-gray-100 uppercase"> Brand </th>
                                        <th class="!text-xs bg-gray-100 uppercase"> Part No. </th>
                                ...
                                <tbody>
                                    <tr class="">
                                        ...
                                        <td class="!text-xs">  Herman Beck </td>
                                        <td class="!text-xs"> Photoshop </td>
                                        <td class="!text-xs"> $ 77.99 </td>
                                        <td class="!text-xs p-1" align="center">
                                            <a href="/items/edit" class="btn btn-xs btn-info text-white p-1">
