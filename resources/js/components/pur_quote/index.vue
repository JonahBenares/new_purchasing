                            ...
                            <table class="table table-bordered table-hover !border ">
                                <thead>
                                    <tr>
                                        ...
                                        <th class="!text-xs bg-gray-100 uppercase" width="20%"> RFQ Series</th>
                                ...
                                <tbody>
                                    <tr class="">
                                        <td class="!align-top !text-xs"> ITB24-1322-CNPR </td>
                                        <td class="!align-top !text-xs"> 2024-07-30 </td>
                                        <td class="!align-top !text-xs"> 2024-07-16 </td>
                                        <td class="!align-top !text-xs"> 
                                            <ul class="m-0 p-0 !text-xs">
                                                <li>Fuel and Lube Management</li>
                                                <li>Fuel and Lube Management</li>
                                                <li>Fuel and Lube Management</li>
                                            </ul>
                                        </td>
