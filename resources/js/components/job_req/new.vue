								...
								<div class="col-lg-12">
									<table class="w-full table-bordered !text-xs mt-3">
										...
										<tr>
											...
											<td class="p-0 align-top"><input type="text" class="w-full p-1 text-center" id="scope_qty_check" placeholder="00" v-model="scope_qty"  min="0" onkeypress="return (event.charCode !=8 && event.charCode ==0 || (event.charCode >= 48 && event.charCode <= 57))"></td>
											...
											<td class="p-0 align-top"><input type="text" id="scope_unit_cost_check" class="w-full p-1 text-center" placeholder="00" v-model="scope_unit_cost" min="0" onkeypress="return (event.charCode !=8 && event.charCode ==0 || (event.charCode >= 48 && event.charCode <= 57))"></td>
								...
								<div class="col-lg-12">
									<table class="w-full table-bordered !text-xs mt-3">
										...
										<tr>
											...
											<td class=""><input placeholder="PN No." type="text" v-model="pn_no" class="w-full p-1"></td>
											<td class=""><input placeholder="Item Description" id="item_check" v-model="item_desc" type="text" class="w-full p-1"></td>
											<td class=""><input placeholder="WH Stock" type="text" v-model="wh_stocks" min="0" onkeypress="return (event.charCode !=8 && event.charCode ==0 || (event.charCode >= 48 && event.charCode <= 57))" class="w-full p-1"></td>
											<td class=""><input placeholder="Date Needed" type="text" v-model="date_needed" class="w-full p-1" onfocus="(this.type='date')"></td>
											<td class="p-1"><input placeholder="Recom Date" type="text" v-model="recom_date" class="w-full p-1" onfocus="(this.type='date')"></td>
											<td class="text-center">
												<button class="btn btn-primary p-1" @click="addItem">
