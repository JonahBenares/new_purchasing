								...
								<div class="col-lg-12">
									<table class="w-full table-bordered !text-xs mt-3">
										...
										<tr>
											...
											<td class="p-0 align-top"><textarea placeholder="" class="w-full p-1 resize"></textarea></td>
											<td class="p-0 align-top"><input type="text" class="w-full p-1 text-center" placeholder="00"></td>
											<td class="p-0 align-top"><input type="text" class="w-full p-1 text-center" placeholder="lot"></td>
											<td class="p-0 align-top"><input type="text" class="w-full p-1 text-center" placeholder="00"></td>
											<td class="p-0 align-top"><input type="text" class="w-full p-1 text-center" placeholder="00"></td>
							...
							<div class="row">
								<div class="col-lg-12">
									<table class="w-full table-bordered !text-xs mt-3">
										...
										<tr>
											<td class="p-1 text-center align-top">#</td>
											<td class="p-0 align-top"><textarea placeholder="" class="w-full p-1 resize" rows="1"></textarea></td>
											<td class="text-center">
												<button class="btn btn-primary p-1" @click="addItem">
													<PlusIcon fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="menu-icon w-3 h-3 "></PlusIcon>
												</button>
