            ...
            <div class="row  ">
                <div class="col-lg-12">
                    <div class=" flex justify-between  px-2 ">
                        <div class="flex">
                            <h3 class="card-title !text-lg m-0 uppercase font-bold text-gray-600">JOR WEEKLY RECOMMENDATION <small>Encode</small></h3>
                        </div>
						...
						<div class="row mt-4"> 
							<div class="col-lg-12 col-md-12">
								<div class="flex justify-center space-x-2">
									<a href="/job_weekly_report/new" class="btn !bg-gray-100 btn-sm !rounded-full w-full">Close</a>
								</div>
							</div>
						</div>
					</div>
