<script setup>
    ...
    const getallDr = async () => {
		let response = await axios.get("/api/get_alldr");
		get_alldr.value = response.data.drall;
	}
    const options = {
		// dom: 'Bftip',
            ...
            <div class="col-lg-12 stretch-card">
                <div class="card">
                    <div class="card-body">
                        ...
                        <div class=" pt-3">
                            <DataTable :data="get_alldr" :options="options" class="display table table-bordered table-hover !border nowrap">
                                <thead>
                                    <tr>
                                        <th class="!text-xs bg-gray-100 uppercase text-center" width="5%"> DR Date</th>
                                        <th class="!text-xs bg-gray-100 uppercase text-center" width="10%"> DR No</th>
                                        <th class="!text-xs bg-gray-100 uppercase text-center" width="10%"> PO No</th>
                                        <th class="!text-xs bg-gray-100 uppercase text-center" width="10%"> Mode</th>
                                ...
                                <template #column-4="props">
                                    <a :href="'/pur_dr/view/'+props.rowData.id" class="btn btn-xs btn-warning text-white p-1">
