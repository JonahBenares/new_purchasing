            ...
            <div class="col-md-12 mb-3">
                <div class="card bg-gradient-primary border-0">
                    <div class="card-body py-3 px-4 d-flex align-items-center justify-content-between flex-wrap">
                        ...
                        <div class="d-flex">
                            <a :href="'/job_issue/print_coc/'+props.id" target="_blank" class="btn btn-outline-light mr-2 bg-gradient-danger border-0">View COC</a>
								...
								<div class="row">
									...
									<div class="col-lg-6 col-sm-6 col-md-6">
										<div class="flex">
											...
											<input type="text" class="border-b bg-white w-full text-sm py-0" disabled :value="joi_head.joi_no + (joi_head.revision_no !== 0 && joi_head.revision_no !== null ? '.r' + joi_head.revision_no : '')">
										</div>
									</div>
								</div>
								<div class="" >
