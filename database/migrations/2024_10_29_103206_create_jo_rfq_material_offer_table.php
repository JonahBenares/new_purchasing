...
return new class extends Migration
{
    ...
    {
        Schema::create('jo_rfq_material_offer', function (Blueprint $table) {
            $table->id();
            $table->integer('jo_rfq_head_id')->default(0);
            $table->string('jor_no')->nullable();
            $table->integer('jo_rfq_vendor_id')->default(0);
            $table->integer('jo_rfq_material_details_id')->default(0);
    ...
    {
        Schema::dropIfExists('jo_rfq_material_offer');
    }
};
